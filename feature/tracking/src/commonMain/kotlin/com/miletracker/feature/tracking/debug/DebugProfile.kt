...
object DebugProfiles {
    ...
    val PERFORMANCE_TESTING = DebugProfile(
    ...
    val TRACK_MILES_DEBUGGING = DebugProfile(
    ...
    val PRODUCTION_VALIDATION = DebugProfile(
