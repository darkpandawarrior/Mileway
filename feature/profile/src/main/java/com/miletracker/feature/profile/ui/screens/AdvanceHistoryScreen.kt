    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(sdf.format(Date(record.requestedDateMs)), style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
            }
            Column(horizontalAlignment = Alignment.End) {
                Text("₹%,.0f".format(record.amountRupees), style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.Bold)
