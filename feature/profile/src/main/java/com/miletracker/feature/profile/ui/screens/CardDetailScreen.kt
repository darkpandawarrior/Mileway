                        ...
                        Column(
                            ...
                            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                                Column {
                                    ...
                                    Text("₹%,.2f".format(card.balanceRupees), style = MaterialTheme.typography.headlineMedium, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.primary)
                                }
                                Column(horizontalAlignment = Alignment.End) {
                                    Text("Credit Limit", style = MaterialTheme.typography.labelSmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                                    Text("₹%,.0f".format(card.creditLimitRupees), style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Medium)
                                }
                            }
                        }
                    }
...
private fun TransactionRow(txn: CardTransaction) {
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            Text("${txn.category} · ${sdf.format(Date(txn.dateMs))}", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
        }
