                        ...
                        Column(
                            ...
                            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                                Column {
                                    ...
                                    Text(
                                        "₹${card.balanceRupees.formatDecimal(2)}",
        ...
        AlertDialog(
            ...
            text = {
                Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth()) {
                    ...
                    Text(
                        "For demo purposes, the PIN is not shown.",
...
private fun TransactionRow(txn: CardTransaction) {
    ...
    Row(
        ...
        Box(
            ...
            Surface(color = MaterialTheme.colorScheme.secondaryContainer, shape = CircleShape, modifier = Modifier.size(36.dp)) {
                Box(contentAlignment = Alignment.Center) {
                    Text(
                        txn.category.firstOrNull()?.toString() ?: "?",
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            Text(
                "${txn.category} · ${Instant.fromEpochMilliseconds(txn.dateMs).toLocalDateTime(TimeZone.currentSystemDefault()).let {
                        ldt ->
