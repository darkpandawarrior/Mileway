...
object ApprovalsRepository {
    ...
    val all: List<ApprovalItem> = listOf(
        ...
        ApprovalItem("A003", ApprovalType.TRAVEL, "Aisha Khan", "Bangalore–Pune flight", 8400.0, ApprovalStatus.PENDING, BASE_MS - 4 * H, policyViolation = true),
        ...
        ApprovalItem("A008", ApprovalType.EXPENSE, "Mohan Das", "Medical claim ₹6,200", 6200.0, ApprovalStatus.REJECTED, BASE_MS - 2 * DAY - H, policyViolation = true),
    ...
    fun clarificationThread(id: String): List<ClarificationMessage> = listOf(
    ...
    fun reject(id: String): List<ApprovalItem> = all.map {
