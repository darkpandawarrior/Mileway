package com.miletracker.feature.travel.ui.previews
...
private val sampleFlightActive = BookingRecord(
    id = "BK001",
...
private val sampleTrainUpcoming = BookingRecord(
    id = "BK003",
...
private val sampleFlightCompleted = BookingRecord(
    id = "BK005",
    mode = TransportMode.FLIGHT,
    origin = "DEL",
    destination = "PNQ",
...
private fun modeIcon(mode: TransportMode): ImageVector = when (mode) {
