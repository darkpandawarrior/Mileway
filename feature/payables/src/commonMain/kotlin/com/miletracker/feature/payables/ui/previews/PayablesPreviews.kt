...
private val samplePoApproved = PurchaseOrder(
    id = "PO-2026-0042",
...
private val samplePoPending = PurchaseOrder(
    id = "PO-2026-0055",
...
private fun PoSummaryCard(po: PurchaseOrder) {
    val (statusColor, statusLabel) = when (po.status) {
