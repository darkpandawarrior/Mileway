...
val eventsModule =
    module {
        ...
        // V29 P29.E.1: takes the nav-supplied event id as a runtime parameter, mirrors
        // TrackingSuccessViewModel's `viewModel { params -> ... }` shape.
        viewModel { params -> EventDetailViewModel(eventId = params.get(), repository = get()) }
