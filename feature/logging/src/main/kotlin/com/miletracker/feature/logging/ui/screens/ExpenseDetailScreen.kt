...
private fun ReceiptPlaceholder(expense: ExpenseRecord) {
    Card(
        ...
        Column(
            ...
            Text(
                text = "₹%,.2f".format(expense.amountRupees),
        ...
        Column(
            ...
            lineItems.forEach { item ->
                Row(
                    ...
                    Spacer(Modifier.size(DesignTokens.Spacing.l))
                    Text("₹%,.0f".format(item.amount), style = MaterialTheme.typography.bodySmall, fontWeight = FontWeight.Medium)
                }
            }
            ...
            Row(
                ...
                Text("₹%,.2f".format(expense.amountRupees), style = MaterialTheme.typography.labelMedium, fontWeight = FontWeight.Bold)
            }
        }
    }
}
