...
fun VerifyDistanceDialog(
    ...
    var text by remember { mutableStateOf("%.2f".format(currentKm)) }
            ...
            Column(verticalArrangement = Arrangement.spacedBy(DesignTokens.Spacing.m)) {
                ...
                Surface(
                    ...
                    Row(
                        ...
                        LabeledValue("Calculated", "%.2f km".format(calculatedKm))
                        LabeledValue("Current", "%.2f km".format(currentKm), alignEnd = true)
                    }
                }
                OutlinedTextField(
                    value = text,
