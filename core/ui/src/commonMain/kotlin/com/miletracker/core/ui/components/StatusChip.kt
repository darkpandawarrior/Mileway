...
/**
 * The six DiCE status tones (F0.3) — a generalisation of cards' `CardStatusBadge`, reused by every V17
 * status chip / history list. Hex values match the DiCE design system.
 */
