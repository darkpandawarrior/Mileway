 ...
 * Android implementations live in `androidMain` (Phase 2.2), iOS in `iosMain` (Phase 4).
 *
 * Note: camera capture and maps are NOT modelled here — they are Compose UI components provided by
 * multiplatform libraries (peekaboo for camera/image-picker, maplibre-compose for maps) and live in
 * the UI layer, not as background services.
 */
