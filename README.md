...
<!-- AUTOGEN:stats -->
> **At a glance** — **28-module** clean architecture (11 feature · 9 core), Room schema **v31**, **131** host-rendered Roborazzi screenshots (JVM, no emulator). *Numbers auto-generated from `settings.gradle.kts` by `scripts/gen-readme.sh`.*
<!-- /AUTOGEN:stats -->
