...
<!-- AUTOGEN:stats -->
> **At a glance** — **31-module** clean architecture (11 feature · 12 core), Room schema **v47**, **149** host-rendered Roborazzi screenshots (JVM, no emulator). *Numbers auto-generated from `settings.gradle.kts` by `scripts/gen-readme.sh`.*
<!-- /AUTOGEN:stats -->
