...
import com.miletracker.core.network.model.CompletionCategory
...
object ProfileMockData {
    ...
    fun primaryProfile(): EmployeeProfile = EmployeeProfile(
        name = "Demo User",
     ...
     */
    fun sessions(): List<UserSession> = listOf(
        UserSession(
    ...
    fun accounts(): List<DemoAccount> = listOf(
        DemoAccount(
            id = "ACC-001",
