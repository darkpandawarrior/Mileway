...
private fun sampleGroups(): List<SearchResultGroup> =
    listOf(
        SearchResultGroup(
            ...
            results =
                listOf(
                    SearchResult(SearchEntityType.TRIP, "t1", "Goa offsite", "Mar 12 · 248 km", status = "Submitted", dateEpochDay = 20_160, deeplink = "miletracker://travel/t1"),
                    SearchResult(SearchEntityType.TRIP, "t2", "Client visit · Pune", "Mar 09 · 41 km", status = "Approved", dateEpochDay = 20_157, deeplink = "miletracker://travel/t2"),
                ),
        ),
        SearchResultGroup(
            ...
            results =
                listOf(
                    SearchResult(SearchEntityType.QR, "p1", "Paid · Chai Point", "UPI · Reimbursable", status = "Completed", amount = 240.0, dateEpochDay = 20_158, deeplink = "miletracker://payments/p1"),
                ),
        ),
        SearchResultGroup(
            ...
            results =
                listOf(
                    SearchResult(SearchEntityType.EVENT, "e1", "Quarterly summit", "Bengaluru · 3 days", status = "Upcoming", dateEpochDay = 20_170, deeplink = "miletracker://events/e1"),
                ),
        ),
    )
