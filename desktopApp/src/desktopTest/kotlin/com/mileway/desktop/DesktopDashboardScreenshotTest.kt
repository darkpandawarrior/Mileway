...
class DesktopDashboardScreenshotTest {
    ...
    @Test
    @Ignore("Manual screenshot generator (writes docs/screenshots/desktop_dashboard.png). Flaky under headless Skiko in CI — run explicitly with --tests when regenerating the desktop showcase image.")
    fun captureDesktopDashboard() = runDesktopComposeUiTest(width = 900, height = 700) {
